(function(){
	...
	angular.module('safeguard.core').factory('auth.service',['$http','$location','$q','localStorageService','serverUrl', function ($http,$location, $q,localStorageService, serverUrl) {
